...
st.set_page_config(page_title="웹툰 반응 비교 대시보드", layout="wide")
...
mode = st.sidebar.radio(
    "화면 선택",
    ["데이터 개요", "단일 작품 모니터링", "두 웹툰 비교", "베스트 댓글 원문", "데이터 확인"],
)
...
# ════════════════════════════════════════════════════════════
    ...
    tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["회차 흐름", "구간 요약", "구간 병치 라인차트", "공개 후 누적 댓글", "전체 지표 통합", "작성자 팬층", "상세 테이블"])
    with tab1:
